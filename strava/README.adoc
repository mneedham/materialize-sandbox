...
This repository goes with the following blog post: Materialize: https://markhneedham.com/blog/2020/12/17/materialize-querying-json-file[Querying JSON files^]
